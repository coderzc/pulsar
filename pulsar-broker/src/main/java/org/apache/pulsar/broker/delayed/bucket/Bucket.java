...
abstract class Bucket {
    ...
    Bucket(String dispatcherName, ManagedCursor cursor, AsyncLinearExecutor linearExecution,
           BucketSnapshotStorage storage, long startLedgerId, long endLedgerId) {
        this(dispatcherName, cursor, linearExecution, storage, startLedgerId, endLedgerId, new HashMap<>(), -1, -1, 0,
                0, null, null);
    }
